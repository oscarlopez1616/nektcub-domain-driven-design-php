...
class CubeControllerTest extends WebTestCase
{
    ...
    {
        return array(
            array('/api/cube/volume?x1=0&y1=0&z1=0&edge1=3&x2=3&y2=0&z2=0&edge2=3', 200, '{"unit":"m3","meassure":0}'),
            array('/api/cube/volume?x1=0&y1=0&z1=0&edge1=3&x2=0&y2=0&z2=0&edge2=3', 200, '{"unit":"m3","meassure":27}'),
            array('/api/cube/volume?x1=0&y1=0&z1=0&edge1=3&x2=1&y2=0&z2=0&edge2=3', 200, '{"unit":"m3","meassure":18}')
        );
    }
}
